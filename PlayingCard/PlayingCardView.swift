...
//  PlayingCard
//
//  Created by Alvin Tan De Jun on 14/7/18.
...
class PlayingCardView: UIView {
    ...
    lazy private var upperLeftLabel: UILabel = createCornerLabel()
    lazy private var lowerRightLabel: UILabel = createCornerLabel()
    ...
    override func layoutSubviews() {
        ...
        lowerRightLabel.transform = CGAffineTransform.identity.translatedBy(x: lowerRightLabel.frame.size.width, y: lowerRightLabel.frame.size.height).rotated(by: CGFloat.pi)
